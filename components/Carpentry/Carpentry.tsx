...
export function Carpentry() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const response = await fetch('/api/fetch-data-carpentry');
        ...
        console.log('Processed subfolders:', processedSubfolders);
  ...
  return (
    <div className="flex h-full" style={{ backgroundColor: colors.dark }}>
      ...
      <div className="flex-grow overflow-y-auto w-full" id="carpentry">
        <div className="relative h-screen w-full">
          ...
          <div className="container mx-auto px-4 z-10 relative h-full flex items-center justify-center">
              ...
              <div className="flex flex-col gap-6 items-center">
                <Link href="/#galleries" passHref legacyBehavior>
                  <motion.a
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="text-gray-300 hover:text-white flex items-center gap-1 font-medium text-lg"
                  >
                    <ChevronLeft size={20} />
